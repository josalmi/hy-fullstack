...
describe("favorite blog", () => {
  ...
  test("of list with single element is element itself", () => {
    expect(listHelper.favoriteBlog([blogs[0]])).toBe(blogs[0]);
  });
...
describe("most blogs", () => {
  ...
  test("of list with single element is author of the blog", () => {
